    ...
    return NextResponse.json(
      {
        code: 400,
        message:
          "Expected color-preference payload to contain colorMode property",
      },
      {
        status: 400,
      }
    ...
    return NextResponse.json(
      {
        code: 400,
        message:
          "Expected color-preference payload to contain colorMode property that is either light or dark",
      },
      {
        status: 400,
      }
